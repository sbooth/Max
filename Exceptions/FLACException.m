...
@implementation FLACException

+ (NSException *) exceptionWithReason:(NSString *)reason userInfo:(NSDictionary *)userInfo
{
	return [[[FLACException alloc] initWithReason:reason userInfo:userInfo] autorelease];
}

- (id) initWithReason:(NSString *)reason userInfo:(NSDictionary *)userInfo
{
	return [super initWithName:@"FLACException" reason:reason userInfo:userInfo];
}
