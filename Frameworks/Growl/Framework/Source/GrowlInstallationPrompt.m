...
#define DEFAULT_INSTALLATION_EXPLANATION NSLocalizedStringFromTableInBundle(@"This program displays information via Growl, a centralized notification system.  Growl is not currently installed; to see Growl notifications from this and other applications, you must install it.  No download is required.", @"GrowlInstallation", [NSBundle bundleForClass:[self class]], @"Default Growl installation explanation")
#define DEFAULT_UPDATE_EXPLANATION NSLocalizedStringFromTableInBundle(@"This program displays information via Growl, a centralized notification system.  A version of Growl is currently installed, but this program includes an updated version of Growl.  It is strongly recommended that you update now.  No download is required.", @"GrowlInstallation", [NSBundle bundleForClass:[self class]], @"Default Growl update explanation")
