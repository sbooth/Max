...
extern int16_t *paranoia_read(cdrom_paranoia *p,void(*callback)(long,int,void*),void*);
extern int16_t *paranoia_read_limited(cdrom_paranoia *p,void(*callback)(long,int,void*),void *userdata,int maxretries);
