 ...
 ********************************************************************
 ...
 last mod: $Id: mapping0.c 2009-03-11 aoyumi $
...
static int mapping0_forward(vorbis_block *vb){
  ...
  
  {
	...
	_vp_offset_and_mix(psy_look,
			   ...
			   *lowcomp,
			   ...
			   blocktype, modenumber,
			   vb->nW,
			   b->lW_blocktype, b->lW_modenumber, b->lW_no, b->impadnum);
  ...
  */
...

  {
	...
	_vp_noise_normalize_sort(psy_look,mdct,sortindex[i],lowpass_residue);
      }
    }
	...
	_residue_P[ci->residue_type[resnum]]->
      ...
      if(!b->lW_modenumber && !b->lW_blocktype && !modenumber && blocktype) b->impadnum=1;
      else if(b->impadnum) b->impadnum++;
      if(modenumber) b->impadnum=0; // if (present window == (long or trans.) ) impadnum=0 [reset]
