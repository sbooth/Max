...
@interface CompactDiscDocumentSettingsSheet (Private)
- (void)	updateOutputDirectoryMenuItemImage;
- (void)	updateTemporaryDirectoryMenuItemImage;
@end

@implementation CompactDiscDocumentSettingsSheet
...
@implementation CompactDiscDocumentSettingsSheet (Private)
